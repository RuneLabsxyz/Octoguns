...
// Generated by dojo-bindgen on Thu, 29 Aug 2024 02:30:33 +0000. Do not modify this file manually.
...
// Type definition for `octoguns::models::character::CharacterPosition` struct
...
export function defineContractComponents(world: World) {
    return {
        ...
        // Model definition for `octoguns::models::character::CharacterPosition` model
        CharacterPosition: (() => {
            return defineComponent(
                world,
                {
