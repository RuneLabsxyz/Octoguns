...
// Generated by dojo-bindgen on Tue, 15 Oct 2024 07:01:07 +0000. Do not modify this file manually.
...
export async function setupWorld(provider: DojoProvider) {
    ...
    function mapmaker() {
        ...
        const create = async (props: { account: Account, grid1: models.U256, grid2: models.U256, grid3: models.U256 }) => {
            try {
                return await provider.execute(
                    props.account,
                    {
