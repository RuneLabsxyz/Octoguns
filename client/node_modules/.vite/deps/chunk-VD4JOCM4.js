...
function instance($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key2) => {
    if (!~writable_props.indexOf(key2) && key2.slice(0, 2) !== "$$" && key2 !== "slot")
      console.warn(`<HierarchicalObject> was created with unknown prop '${key2}'`);
  });
  $$self.$$set = ($$props2) => {
    if ("object" in $$props2)
      $$invalidate(2, object = $$props2.object);
    if ("onChildMount" in $$props2)
      $$invalidate(3, onChildMount = $$props2.onChildMount);
    if ("onChildDestroy" in $$props2)
      $$invalidate(4, onChildDestroy = $$props2.onChildDestroy);
    if ("parent" in $$props2)
...
function instance2($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key2) => {
    if (!~writable_props.indexOf(key2) && key2.slice(0, 2) !== "$$" && key2 !== "slot")
      console.warn(`<SceneGraphObject> was created with unknown prop '${key2}'`);
  });
...
function add_css(target) {
  append_styles(target, "svelte-z3m47x", "canvas.svelte-z3m47x{display:block}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJmaWxlIjoiQ2FudmFzLnN2ZWx0ZSIsIm1hcHBpbmdzIjoiQUF5SUUscUJBQ0UsYUFDRiIsIm5hbWVzIjpbXSwiaWdub3JlTGlzdCI6W10sInNvdXJjZXMiOlsiQ2FudmFzLnN2ZWx0ZSJdfQ== */");
}
...
function instance3($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key2) => {
    if (!~writable_props.indexOf(key2) && key2.slice(0, 2) !== "$$" && key2 !== "slot")
      console.warn(`<Canvas> was created with unknown prop '${key2}'`);
  });
  ...
  $$self.$$set = ($$props2) => {
    if ("colorManagementEnabled" in $$props2)
      $$invalidate(5, colorManagementEnabled = $$props2.colorManagementEnabled);
    if ("colorSpace" in $$props2)
      $$invalidate(6, colorSpace = $$props2.colorSpace);
    if ("dpr" in $$props2)
      $$invalidate(7, dpr = $$props2.dpr);
    if ("renderMode" in $$props2)
      $$invalidate(8, renderMode = $$props2.renderMode);
    ...
    if ("autoRender" in $$props2)
      $$invalidate(14, autoRender = $$props2.autoRender);
    if ("$$scope" in $$props2)
  ...
  $$self.$inject_state = ($$props2) => {
    ...
    if ("initialized" in $$props2)
      $$invalidate(3, initialized = $$props2.initialized);
  };
  if ($$props && "$$inject" in $$props) {
    $$self.$inject_state($$props.$$inject);
  }
...
function instance4($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key2) => {
    if (!~writable_props.indexOf(key2) && key2.slice(0, 2) !== "$$" && key2 !== "slot")
      console.warn(`<DisposableObject> was created with unknown prop '${key2}'`);
  });
  $$self.$$set = ($$props2) => {
    if ("object" in $$props2)
      $$invalidate(2, object = $$props2.object);
...
function instance5($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$new_props) => {
    ...
    if ("is" in $$new_props)
      $$invalidate(4, is = $$new_props.is);
    if ("args" in $$new_props)
      $$invalidate(5, args = $$new_props.args);
    if ("attach" in $$new_props)
      $$invalidate(6, attach = $$new_props.attach);
    if ("manual" in $$new_props)
      $$invalidate(7, manual = $$new_props.manual);
    if ("makeDefault" in $$new_props)
      $$invalidate(8, makeDefault = $$new_props.makeDefault);
    if ("dispose" in $$new_props)
      $$invalidate(0, dispose = $$new_props.dispose);
    if ("ref" in $$new_props)
      $$invalidate(3, publicRef = $$new_props.ref);
  ...
  $$self.$inject_state = ($$new_props) => {
    ...
    if ("publicRef" in $$props)
      $$invalidate(3, publicRef = $$new_props.publicRef);
  };
  if ($$props && "$$inject" in $$props) {
    $$self.$inject_state($$props.$$inject);
  }
...
//# sourceMappingURL=chunk-VD4JOCM4.js.map
