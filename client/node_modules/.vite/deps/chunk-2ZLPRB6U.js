...
function M(e) {
  ...
  return e.world.registerDisposer(() => d?.unsubscribe()), { ...e, getEntitiesWithValue: n };
}
function X(e, t) {
...
function b(e) {
  return e.metadata?.componentName ?? e.metadata?.tableName ?? e.metadata?.tableId ?? e.metadata?.contractId ?? e.id;
}
function se(e, t, n) {
  if (Object.keys(t).length === 0)
    throw new Error("Component schema must have at least one key");
  let r = n?.id ?? ue(), i = $r(t, () => /* @__PURE__ */ new Map()), m = new Subject(), d = n?.metadata, u = { values: i, schema: t, id: r, update$: m, metadata: d, entities: () => I(Object.values(i)[0].keys(), v), world: e };
  return n?.indexed && (u = M(u)), e.registerComponent(u), u;
}
function E(e, t, n, r = {}) {
  let i = p(t), m = g(e, t);
  for (let [d, l] of Object.entries(n))
    e.values[d] ? e.values[d].set(i, l) : e.metadata?.tableId && /^\d+$/.test(d) || console.warn("Component definition for", b(e), "is missing key", d, ", ignoring value", l, "for entity", t, ". Existing keys: ", Object.keys(e.values));
...
function g(e, t) {
  ...
  for (let m of i) {
    ...
    if (d === void 0 && !w.includes(e.schema[m]))
      return;
    n[m] = d;
  }
  return n;
...
function ye(e, t) {
  ...
  return e.world.registerDisposer(() => x2?.unsubscribe()), e;
}
function xe(e, t, n) {
...
function A2(e, t) {
  ...
  for (let y2 = 0; y2 < e.length; y2++) {
    ...
    if (J(o))
      ...
      if (n = o.type === 0 ? /* @__PURE__ */ new Set([...V(o.component)]) : Se(o.component, o.value), a && a.depth > 0)
        for (let p2 of [...n])
...
function f(e, t) {
  let n = t?.runOnInit || t?.initialSet ? A2(e, t.initialSet) : /* @__PURE__ */ new Set(), r = observable(n), a = from(r).pipe(Y(e[0].component)), y2 = e.findIndex((p2) => [5, 4].includes(p2.type)) !== -1, o = merge(...e.map((p2) => p2.component.update$)).pipe(y2 ? concatMap((p2) => {
    let m = A2(e, t?.initialSet), d = [];
    for (let i of r)
...
function x(e, t, n) {
  let r = t.subscribe(n);
  e.registerDisposer(() => r?.unsubscribe());
}
...
function at(e, t, n, r = { runOnInit: true }) {
  let a = r?.runOnInit ? from(V(t)).pipe(Y(t)) : EMPTY;
  x(e, concat(a, t.update$), n);
}
function yt(e, t, n, r, a = { update: false, runOnInit: true }) {
  _14(e, t, ({ entity: y2, type: o }) => {
    o === 0 && E(n(y2), y2, r(y2)), o === 1 && le(n(y2), y2), a?.update && o === 2 && E(n(y2), y2, r(y2));
  }, a);
}
function lt() {
...
@latticexyz/utils/dist/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-2ZLPRB6U.js.map
