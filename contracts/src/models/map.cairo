...
impl MapImpl of MapTrait {
    ...
    fn new_empty(map_id: u32) -> Map {
        Map {map_id, map_objects: MapObjects { objects: ArrayTrait::new()}}
    }

    // Returns the bounds of the object in the map.
    // (x_min, x_max, y_min, y_max)
    fn get_object_bounds(self: @Map, index: u8) -> (u32, u32, u32, u32) {
        assert!(index.into() < self.map_objects.objects.len(), "Index out of bounds");
        let object = *self.map_objects.objects.at(index.into());
